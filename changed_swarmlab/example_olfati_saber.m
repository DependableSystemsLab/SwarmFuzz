...
DEBUG = true; % Elaine - Fuzz Change to false
VIDEO = true; % Elaine - Fuzz to false
...
% Init video
% ------ for fuzzing, change 1 to 0, disable the visualization ------
VIDEO = 0;
DEBUG = 0;
if VIDEO    
...
% ------ comment for fuzzing, distable the visualization ------
% Init viewer
